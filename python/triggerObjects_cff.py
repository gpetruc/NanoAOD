...
triggerObjectTable = cms.EDProducer("TriggerObjectTableProducer",
    ...
    selections = cms.VPSet(
        cms.PSet(
            ...
            l2seed = cms.string("type(83) && coll('hltIterL3MuonCandidates')"),  l2deltaR = cms.double(0.5),
        ),
        cms.PSet(
        ...
        cms.PSet(
            ...
            l1seed = cms.string("type(-100) && coll('hltGtStage2Digis:Tau')"), l1deltaR = cms.double(0.5),

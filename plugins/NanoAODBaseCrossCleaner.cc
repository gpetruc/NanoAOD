...
NanoAODBaseCrossCleaner::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    auto jetsTable = std::make_unique<FlatTable>(jetsIn->size(),jetName_,false);
    ...
    auto muonsTable = std::make_unique<FlatTable>(muonsIn->size(),muonName_,false);
    ...
    auto electronsTable = std::make_unique<FlatTable>(electronsIn->size(),electronName_,false);
    ...
    auto tausTable = std::make_unique<FlatTable>(tausIn->size(),tauName_,false);
    ...
    auto photonsTable = std::make_unique<FlatTable>(photonsIn->size(),photonName_,false);

...
NanoAODBaseCrossCleaner::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    auto jetsTable = std::make_unique<FlatTable>(jetsIn->size(),"Jet",false,true);
    ...
    auto muonsTable = std::make_unique<FlatTable>(muonsIn->size(),"Muon",false,true);
    ...
    auto electronsTable = std::make_unique<FlatTable>(electronsIn->size(),"Electron",false,true);
    ...
    auto tausTable = std::make_unique<FlatTable>(tausIn->size(),"Tau",false,true);
    ...
    auto photonsTable = std::make_unique<FlatTable>(photonsIn->size(),"Photon",false,true);
